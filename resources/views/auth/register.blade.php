...
<head>
    ...
    <title>Register - BlogScript</title>
    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            <div class="mx-auto h-12 w-auto flex justify-center">
                <h2 class="text-3xl font-bold text-primary">BlogScript</h2>
            </div>
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
                ...
                <div class="flex">
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>Your account will require admin approval before you can log in. You'll be notified once approved.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <a href="{{ route('home') }}" class="text-primary hover:text-secondary">← Back to Homepage</a>
            </div>
        </form>
    </div>
</body>
