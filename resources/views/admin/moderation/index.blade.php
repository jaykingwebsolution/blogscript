    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-spotify-light-gray text-sm">Pending Music</p>
                    <p class="text-3xl font-bold text-yellow-400">{{ $stats['pending_music'] }}</p>
                </div>
        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-spotify-light-gray text-sm">Pending Artists</p>
                    <p class="text-3xl font-bold text-blue-400">{{ $stats['pending_artists'] }}</p>
                </div>
        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-spotify-light-gray text-sm">Pending Posts</p>
                    <p class="text-3xl font-bold text-green-400">{{ $stats['pending_posts'] }}</p>
                </div>
        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-spotify-light-gray text-sm">Pending Media</p>
                    <p class="text-3xl font-bold text-purple-400">{{ $stats['pending_media'] }}</p>
                </div>
