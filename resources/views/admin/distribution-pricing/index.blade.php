...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Distribution Pricing Management</h1>
            <p class="text-gray-600">Manage distribution pricing plans with different durations</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">Min Price</p>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.distribution-pricing.destroy', $plan) }}" 
                                          onsubmit="return confirm('Are you sure you want to delete this distribution pricing plan?')" class="inline">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                No distribution pricing plans found. <a href="{{ route('admin.distribution-pricing.create') }}" class="text-indigo-600 hover:text-indigo-900">Create your first plan</a>.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
