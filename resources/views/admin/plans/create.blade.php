...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Create New Plan</h1>
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="type" name="type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
                            ...
                            <option value="record_label" {{ old('type') == 'record_label' ? 'selected' : '' }}>Record Label</option>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <select name="currency" class="px-3 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                <option value="NGN" {{ old('currency', 'NGN') == 'NGN' ? 'selected' : '' }}>₦</option>
                                <option value="USD" {{ old('currency') == 'USD' ? 'selected' : '' }}>$</option>
                                <option value="EUR" {{ old('currency') == 'EUR' ? 'selected' : '' }}>€</option>
                            </select>
                            <input type="number" id="price" name="price" value="{{ old('price', 0) }}" step="0.01" min="0"
