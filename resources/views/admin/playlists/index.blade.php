        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white">{{ $totalPlaylists }}</p>
                </div>
        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-400">{{ $featuredPlaylistsCount }}</p>
                </div>
        ...
        <div class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-400">{{ $totalTracks }}</p>
                </div>
    ...
    <form method="GET" action="{{ route('admin.playlists.index') }}" class="bg-spotify-gray rounded-xl p-6 border border-spotify-gray mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('admin.playlists.index') }}" class="bg-spotify-dark-gray text-white px-4 py-2 rounded-lg hover:bg-spotify-gray transition-colors border border-spotify-light-gray">
                    Clear
                </a>
            </div>
        </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex space-x-1">
                                            <a href="{{ route('admin.playlists.show', $playlist) }}" class="w-8 h-8 bg-spotify-green rounded-full flex items-center justify-center hover:bg-spotify-green-light transition-colors" title="View">
                                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                                </svg>
                                            </a>
                                            <a href="{{ route('admin.playlists.edit', $playlist) }}" class="w-8 h-8 bg-spotify-dark-gray border border-spotify-light-gray rounded-full flex items-center justify-center hover:bg-spotify-gray transition-colors" title="Edit">
                                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @else
                                            <form method="POST" action="{{ route('admin.playlists.feature', $playlist) }}" style="display: inline;">
                                                @csrf
                                                <button type="submit" class="w-8 h-8 bg-spotify-dark-gray border border-spotify-light-gray rounded-full flex items-center justify-center hover:bg-spotify-gray transition-colors" title="Feature">
                                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                                    </svg>
                                                </button>
